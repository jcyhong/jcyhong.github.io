...
For runs test, the null hypothesis is that the observations are not auto-correlated. A small p-value rejects the null and provides evidence of (nontrivial) autocorrelation.
```{r}
